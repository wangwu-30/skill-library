...
1. Read [docs/delivery-goal.md](../../docs/delivery-goal.md) to confirm the evaluation goal.
2. Read [eval/README.md](../../eval/README.md) for directory and evidence conventions.
...
6. Score the baseline and skill-assisted outputs using [eval/rubrics/house-skill-output-scorecard.md](../../eval/rubrics/house-skill-output-scorecard.md).
